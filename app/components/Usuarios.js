...
export default class Usuarios extends Component<Props> {
  props: Props;
  constructor(props) {
    super(props);
  ...
  getUsuarios() {
    pessoasDao.buscarTodos(usuarios => {
      ...
      Promise.all(users)
        .then(usuariosPromise => this.setState({ usuarios: usuariosPromise }))
        .catch(console.error);
    });
  }
  handleExcluir(user) {
    ...
    return (
      <div>
        <div className="toolbar-actions">
          <NavLink to="/add-usuario" className="btn btn-default pull-right">
